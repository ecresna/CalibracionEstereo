========================================================================
    APLICACIÓN DE CONSOLA: CalibracionEstereoOpencv Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación CalibracionEstereoOpencv.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación CalibracionEstereoOpencv.


CalibracionEstereoOpencv.vcxproj
...
CalibracionEstereoOpencv.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado CalibracionEstereoOpencv.pch y un archivo de tipos precompilados llamado StdAfx.obj.
